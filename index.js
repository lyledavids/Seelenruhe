...
const handlers = {
    'LaunchRequest': function () {
        this.emit(':ask', 'Welcome to Seelenruhe, your personal assistant for rejuvenating Tai Chi and meditation exercises. Say Introduction if you would like to hear an introduction? or Skip if you dont want to');
    },
    ...
    'Intro': function () {
        this.emit(':ask', 'Tai Chi is is a Chinese martial art practiced for both its defense training and its health benefits. Although originally conceived as a martial art, it is also typically practiced for achieving greater longevity and old age physical health. Some training forms of Tai Chi are especially known for being practiced with slow movements and therefore are great for aging bodies. If you are you ready to start exercising? Say start');
    },
    ...
    'NoIntro': function () {
        this.emit(':ask', 'Okay, no introduction, If you are you ready to start exercising? Say start');
    },
    ...
    'YesReady': function () {
        this.emit(':ask', 'Okay, Do you feel full of energy or fatigued today?');
    },
    ...
    'ExerciseStart': function () {
        this.emit(':ask', 'Alright! Before you start your exercise let’s move into the right stance <break time="1s" /> Please stand up straight and follow my instructions <break time="0.3s" /> Lets start <break time="1s" /> Keep your head still and upright and Focus your eyes in the direction of your primary hand. <break time="1s" /> Close your mouth and with your tounge touch the roof of your mouth. <break time="1s" /> Make sure your body is centered and upright. <break time="1s" /> Arch your chest and slightly round your back without hunching it. <break time="1s" /> Loosen the tension around your waist and hips. <break time="1s" /> Relax and lower your shoulders and your elbows. <break time="1s" /> Extend your fingers but keep your wrists relaxed. <break time="0.3s" />Now we can continue to the workout. Say the word ready to start the workout?');
    },
